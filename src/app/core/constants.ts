...
export const ACCOUNT_ICONS = [
  ...
  },
  {
    ...
    icon: "<svg viewBox='0 0 24 24' fill='none' stroke='currentColor' stroke-width='2' stroke-linecap='round' stroke-linejoin='round'><path d='M3 21h18' /><path d='M5 21v-7' /><path d='M19 21v-7' /><path d='M10 9L3 21' opacity='0' /><path d='M2 10l10-7 10 7' /><path d='M12 21v-9' /></svg>",
  },
  {
    name: 'bank_digital',
    defaultColor: 'var(--color-nu-purple)',
    icon: "<svg viewBox='0 0 24 24' fill='none' stroke='currentColor' stroke-width='2' stroke-linecap='round' stroke-linejoin='round'><rect x='5' y='2' width='14' height='20' rx='2' ry='2' /><path d='M12 18h.01' /></svg>",
  },
  {
    name: 'credit_card',
  ...
  },
  {
    ...
    icon: "<svg viewBox='0 0 24 24' fill='none' stroke='currentColor' stroke-width='2' stroke-linecap='round' stroke-linejoin='round'><path d='M12 2L2 12l10 10 10-10L12 2z' /><path d='M12 8v8' /><path d='M8 12h8' /></svg>",
  },
  {
    name: 'money_cash',
    defaultColor: 'var(--color-revenue-green)',
    icon: "<svg viewBox='0 0 24 24' fill='none' stroke='currentColor' stroke-width='2' stroke-linecap='round' stroke-linejoin='round'><rect x='2' y='6' width='20' height='12' rx='2' /><circle cx='12' cy='12' r='2' /><path d='M6 12h.01M18 12h.01' /></svg>",
  },
  {
    name: 'crypto_alt',
    defaultColor: 'var(--color-indigo)',
    icon: "<svg viewBox='0 0 24 24' fill='none' stroke='currentColor' stroke-width='2' stroke-linecap='round' stroke-linejoin='round'><path d='M6 12l6-9 6 9-6 9-6-9z' /></svg>",
  },
  {
    name: 'brand_mastercard',
    defaultColor: 'var(--color-inst-red)',
    icon: "<svg viewBox='0 0 24 24' fill='none' xmlns='http://www.w3.org/2000/svg'><circle cx='7' cy='12' r='6' fill='#EB001B' fill-opacity='0.8'/><circle cx='17' cy='12' r='6' fill='#F79E1B' fill-opacity='0.8'/><path d='M12 15.65C12.8 14.7 13.3 13.4 13.3 12C13.3 10.6 12.8 9.3 12 8.35C11.2 9.3 10.7 10.6 10.7 12C10.7 13.4 11.2 14.7 12 15.65Z' fill='#FF5F00'/></svg>",
  },
  {
    name: 'brand_visa',
    defaultColor: 'var(--color-royal-blue)',
    icon: "<svg viewBox='0 0 24 24' fill='currentColor' xmlns='http://www.w3.org/2000/svg'><path d='M10.7 3.8L7.3 19.8H3.9L7.3 3.8H10.7ZM20.8 4L22.2 11.2C22.2 11.2 23 4.2 23 3.9C22.6 3.8 21.6 3.7 20.8 4ZM15.6 3.8L12.5 19.8H9.1L12.2 3.8H15.6ZM19.5 19.8L21.8 8L21.4 6C20.8 8.1 19.3 15.2 19.3 15.2L17.7 19.8H19.5ZM7.7 13C7.7 10.2 4.4 9.9 4.4 7.6C4.4 6.7 5.3 6.1 6.5 6C7 6 8.5 6.1 9 7L9.6 4.3C8.8 3.9 7.7 3.7 6.5 3.7C3.5 3.7 1.5 5.3 1.5 7.8C1.5 10.8 5 11 5 13.2C5 14.1 4.1 14.7 3.2 14.7C2.4 14.7 1 14.4 0.5 13.9L0 16.6C1 17 2.6 17.5 3.5 17.5C6.7 17.5 8.7 15.9 7.7 13Z'/></svg>",
  },
  {
    name: 'brand_amex',
    defaultColor: 'var(--color-cyan)',
    icon: "<svg viewBox='0 0 24 24' fill='currentColor' xmlns='http://www.w3.org/2000/svg'><path d='M20 4H4C2.9 4 2 4.9 2 6V18C2 19.1 2.9 20 4 20H20C21.1 20 22 19.1 22 18V6C22 4.9 21.1 4 20 4ZM10 14H8.5L8 13H6L5.5 14H4L6.5 9H7.5L10 14ZM14 14H12.5L12 11.5H11V14H10V9H13C13.5 9 14 9.5 14 10V14ZM19 14H15V9H19V10.5H16.5V11H18.5V12.5H16.5V14Z'/></svg>",
  },
  {
    name: 'brand_elo',
    defaultColor: 'var(--color-matte-black)',
    icon: "<svg viewBox='0 0 24 24' fill='currentColor' xmlns='http://www.w3.org/2000/svg'><path d='M12 2C6.48 2 2 6.48 2 12C2 17.52 6.48 22 12 22C17.52 22 22 17.52 22 12C22 6.48 17.52 2 12 2ZM8.5 15.5C7.1 15.5 6 14.4 6 13C6 11.6 7.1 10.5 8.5 10.5H15.5V12.5H8.5C8.2 12.5 8 12.7 8 13C8 13.3 8.2 13.5 8.5 13.5H16V15.5H8.5ZM16.5 11.5H13.5V9.5H16.5C16.8 9.5 17 9.3 17 9C17 8.7 16.8 8.5 16.5 8.5H7.5V6.5H16.5C17.9 6.5 19 7.6 19 9C19 10.4 17.9 11.5 16.5 11.5Z'/></svg>",
  },
  {
    name: 'brand_hipercard',
    defaultColor: 'var(--color-expense-red)',
    icon: "<svg viewBox='0 0 24 24' fill='currentColor' xmlns='http://www.w3.org/2000/svg'><path d='M3 6H21V18H3V6Z' opacity='0.5'/><path d='M16 8H19V16H16V13H14V16H11V8H14V11H16V8Z'/></svg>",
  },
];
...
export const CATEGORY_ICONS = [
  ...
  },
  {
    ...
    icon: "<svg viewBox='0 0 24 24' fill='none' stroke='currentColor' stroke-width='2' stroke-linecap='round' stroke-linejoin='round'><path d='M3 22v-8a2 2 0 0 1 2-2h6a2 2 0 0 1 2 2v8'/><path d='M13 14h2a2 2 0 0 1 2 2v2'/><path d='M15 13L18 7h2'/><path d='M3 6h10v6H3z'/><path d='M3 6l2-3h6l2 3'/></svg>",
  },
  {
  ...
  },
  {
    ...
    icon: "<svg viewBox='0 0 24 24' fill='none' stroke='currentColor' stroke-width='2' stroke-linecap='round' stroke-linejoin='round'><path d='M6.5 6.5l5 5'/><path d='M21 21l-1-1'/><path d='M3 3l1 1'/><path d='M18 22l4-4'/><path d='M2 6l4-4'/><path d='M3 10l7-7'/><path d='M14 21l7-7'/></svg>",
  },
  {
  ...
  },
  {
    ...
    icon: "<svg viewBox='0 0 24 24' fill='none' stroke='currentColor' stroke-width='2' stroke-linecap='round' stroke-linejoin='round'><rect x='2' y='6' width='20' height='12' rx='2'/><path d='M6 12h4'/><path d='M8 10v4'/><line x1='15' y1='13' x2='15.01' y2='13'/><line x1='18' y1='11' x2='18.01' y2='11'/></svg>",
  },
  {
    name: 'category_pets',
